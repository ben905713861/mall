<?php defined('IN_IA') or exit('Access Denied');?><html lang="zh"><head>
...
<div class="header-wrap">
    <header class="public-head-layout wrapper">
        ...
        <div class="nc-regist-now">
            ...
            <span>Hi，欢迎来                        <br>
                        还不是本站会员？立即                        <a title="" href="<?php  echo mobileUrl('pc.account.register')?>" class="register">
                            注册</a>
                    </span>
        </div>
    </header>
...
<div class="nc-login-layout">
    <div class="left-pic"><img src="/addons/ewei_shopv2/plugin/pc/template/mobile/default/static/images/login.jpg" border="0"></div>
    <div class="nc-login fui-page">
        <div class="arrow"></div>
        <div class="nc-login-mode">
            <ul class="tabs-nav">
                <li><a href="#default" class="tabulous_active">用户登录<i></i></a></li><span class="tabulousclear"></span>
            </ul>
            <div id="tabs_container" class="tabs-container" style="height: 199px;">
                <div id="default" class="tabs-content" style="position: absolute; top: 0px;">
                    <form id="login_form" class="nc-login-form" method="post" action="">
                        <input type="hidden" name="formhash" value="GK3Bc-1B0yA42snAevpF7Zpv9EqwVim">                        <input type="hidden" name="form_submit" value="ok">
                        <input name="nchash" type="hidden" value="58181794">
                        <dl>
                            <dt>账&nbsp;&nbsp;&nbsp;号：</dt>
                            <dd>
                                <input type="tel" class="text" name="mobile" id="mobile" placeholder="请输入您的手机号码" value="<?php  echo trim($_GPC['mobile'])?>" maxlength="11" />
                                </dd>
                        </dl>
                        <dl>
                            <dt>密&nbsp;&nbsp;&nbsp;码：</dt>
                            <dd>
                                <input type="password" class="text"  name="pwd" id="pwd" placeholder="请输入您的登录密码" value=""/>
                        ...
                        <div class="handle-div">
                            ...
                            <a class="forget" href="<?php  echo mobileUrl('pc.account.forget')?>">忘记密码？</a>
                        </div>
                        <div class="submit-div">
                            <div class="submit" id="btnSubmit" style="text-align: center;line-height: 42px;">立即登录</div>
...
<div class="sns-login">
    ...
    <div class="icons">
        <?php  if(!empty($sns['wx'])) { ?>
        <div class="item btn-sns" data-sns="wx"><i class="icon icon-wechat1"></i></div>
        <?php  } ?>
        <?php  if(!empty($sns['qq'])) { ?>
...
<script language='javascript'>
    require(['../addons/ewei_shopv2/plugin/pc/biz/member/account.js'], function (modal) {
