    ...
    <div class="ncs-detail ownshop">
        ...
        <div id="ncs-goods-picture" class="ncs-goods-picture">
            <div class="gallery_wrap">
                <div class="gallery"><img title="鼠标滚轮向上或向下滚动，能放大或缩小图片哦~" src="<?php  echo $goods['thumb'];?>"
                                          class="cloudzoom"
                                          data-cloudzoom="zoomImage: '<?php  echo $goods['thumb'];?>'"></div>
            </div>
                    ...
                    <ul>
                        <?php  if(is_array($thumbs)) { foreach($thumbs as $thumb) { ?>
                            <li><img title="鼠标滚轮向上或向下滚动，能放大或缩小图片哦~" class='cloudzoom-gallery'
                                     src="<?php  echo tomedia($thumb)?>"
                                     data-cloudzoom="useZoom: '.cloudzoom', image: '<?php  echo tomedia($thumb)?>', zoomImage: '<?php  echo tomedia($thumb)?>' "
                                " width="60" height="60">
                            </li>
                        <?php  } } ?>
                    </ul>
        ...
        <div class="ncs-goods-summary">
            ...
            <div class="ncs-meta">
                ...
                <dl class="rate">
                    <dt>商品评分：</dt>
                    <!-- S 描述相符评分 -->
                    <dd><span class="raty" data-score="5"></span><a href="#ncGoodsRate">共有<?php  echo $commons['count']['all'];?>
                            条评价</a></dd>
                    <!-- E 描述相符评分 -->
                </dl>
                <!-- E 商品发布价格 -->
                ...
                <dl id="ncs-freight" class="ncs-freight">
                    ...
                    <dd class="ncs-freight_box">
                        <div id="ncs-freight-selector" class="ncs-freight-select">
                            ...
                            <div id="ncs-freight-prompt" style="padding-left: 120px"><strong>有货</strong>
            ...
            <?php  if($goods['canbuy']) { ?>
                <div class="ncs-buy">
                    ...
                    <div class="ncs-btn">
                        ...
                        <?php  if($canAddCart) { ?>
                            <!-- 加入购物车-->
                            <a href="javascript:void(0);" nctype="addcart_submit" class="addcart cartbtn" title="添加购物车"><i
                        ...
                        <div class="ncs-cart-popup">
                            <dl>
                                ...
                                <dd class="btns">
                                    <a href="javascript:void(0);" class="ncs-btn-mini ncs-btn-green"
                                                    onclick="location.href='/index.php?act=cart'">查看购物车</a>
                                    <a href="javascript:void(0);" class="ncs-btn-mini" value=""
                                       onclick="$('.ncs-cart-popup').css({'display':'none'});">继续购物</a>
                                </dd>
                            </dl>
                        </div>
                        <!-- E 加入购物车弹出提示框 -->
        ...
        <div style="position: absolute; z-index: 2; top: -1px; right: -1px;">
            ...
            <div class="ncs-info">
                ...
                <div class="content">
                    ...
                    <div class="goto"><a href="<?php  echo $shop['uro'];?>&r=pc">进入商家店铺</a><a
                ...
                <div class="content">
                    <ul>
                        <?php  if(is_array($history)) { foreach($history as $_g) { ?>
                            <li>
                                <div class="goods-pic"><a title="<?php  echo $_g['title'];?>"
                                                          href="<?php  echo mobileUrl('pc.goods.detail',array('id'=>$_g['goodsid']))?>">
                                        <img alt="" src="<?php  echo $_g['thumb'];?>" rel="lazy"
                                             data-url="<?php  echo $_g['thumb'];?>"/>
                                    </a></div>
    ...
    <div id="content" class="ncs-goods-layout expanded">
                ...
                <div class="ncs-goods-info-content bd" id="ncGoodsRate">
                    <div class="top">
                        ...
                        <div class="percent">
                            ...
                            <dl>
                                <dt>中评<em>(<?php  echo intval($commons['count']['normal']/$commons['count']['all']* 100)?>
                                        %)</em></dt>
                                <dd>
                            ...
                            <dl>
                                <dt>差评<em>(<?php  echo intval($commons['count']['bad']/$commons['count']['all']* 100)?>
                                        %)</em></dt>
                                <dd>
                    ...
                    <div class="ncs-goods-title-nav">
                        <ul id="comment_tab">
                            <li data-type="all" class="current"><a
                                        href="javascript:void(0);">商品评价(<?php  echo $commons['count']['all'];?>)</a></li>
        ...
        <div class="ncs-sidebar">
            <div class="ncs-message-bar">
                <div class="default">
                    <h5><a href="<?php  echo $shop['url'];?>&r=pc"
                           title="<?php  echo $shop['name'];?>"><?php  echo $shop['name'];?></a></h5>
                                    ...
                                    <dl>
                                        ...
                                        <dd class="goods-pic">
                                            ...
                                            <span class="thumb size40"><i></i>
                                                <img src="<?php  echo $_g['thumb'];?>"
                                                     onload="javascript:DrawImage(this,40,40);"></span>
                                            </a>
                                            <p>
                                            <span class="thumb size100"><i></i>
                                                <img src="<?php  echo $_g['thumb'];?>" onload="javascript:DrawImage(this,100,100);"
                                                     title="<?php  echo $_g['title'];?>">
                                            </span>
                                            </p>
                                        </dd>
