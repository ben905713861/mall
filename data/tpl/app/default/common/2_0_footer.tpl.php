<?php defined('IN_IA') or exit('Access Denied');?>		<?php  if(empty($footer_off)) { ?>
			<div class="text-center footer" style="margin:10px 0; width:100%; text-align:center; word-break:break-all;">
				...
				<?php  } else { ?>
					<?php  if(IMS_FAMILY == 'v') { ?><a href="http://www.we7.cc">关于微擎</a>&nbsp;&nbsp;<a href="http://bbs.we7.cc">微擎帮助</a><?php  } ?>
				<?php  } ?>
...
<script>;</script><script type="text/javascript" src="http://127.0.0.1:90/app/index.php?i=2&c=utility&a=visit&do=showjs&m="></script></body>
</html>
