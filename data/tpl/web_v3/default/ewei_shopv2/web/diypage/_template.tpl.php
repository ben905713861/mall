                        ...
                        <div class="detail">
                            ...
                            <p class="productprice  <%if (params.showproductprice !=1) && (params.showsales !=1)%>noheight<%/if%>" >
                                ...
                                <div class="price">
                                    ...
                                    <%/if%>
                                    <%if item.bargain>0%>
                                        <span class="buy bargain-btn" style="background-color: <%style.buybtncolor%>;">砍</span>
                                    <%/if%>
    ...
    <div class="drag" data-itemid="<%itemid%>">
        <div class="fui-cell-group fui-cell-click transparent" style="margin-top: <%style.margintop%>px;">
            ...
            <div class="fui-cell external btn-logout">
                <div class="fui-cell-text" style="text-align: center; color:<%style.subcolor%>;background: <%style.maincolor%>;border:<%style.maincolor%>"><p>退出登录</p></div>
            </div>
        </div>
     </div>
</script>
        ...
        <div class="fui-list-group" style="background: <%style.background%>; margin-top: <%style.margintop%>px;">
                ...
                <%each data as item%>
                    <div class="fui-list">
                        <div class="fui-list-media">
                            <img src="<%item.thumb? imgsrc(item.thumb): '../addons/ewei_shopv2/plugin/diypage/static/images/default/logo.jpg'%>" class="round">
                        </div>
                        <div class="fui-list-inner">
            ...
            <%else%>
                <%each data=["A","B"] as item%>
                    <div class="fui-list">
                        <div class="fui-list-media">
                            <img src="../addons/ewei_shopv2/plugin/diypage/static/images/default/logo.jpg" class="round">
                        </div>
                        <div class="fui-list-inner">
