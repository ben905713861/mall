...
<!---加入短信宝24.03.2018 Leoi----->
                        <div class="form-group">
                        <label class="col-sm-2 control-label" style="text-align:left;">短信宝账号</label>
                        <div class="col-sm-8">
                                <input type="text" name="sms_name" class="form-control" value="<?php  echo $settings['sms_name'];?>" />
                ...
                <div class="form-group">
                        ...
                        <div class="col-sm-8">
                                <input type="password" name="sms_password" class="form-control" value="<?php  echo $settings['sms_password'];?>" />
                        </div>
                </div>
<!---加入短信宝24.03.2018 Leoi----->
