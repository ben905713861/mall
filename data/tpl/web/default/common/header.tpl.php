				...
				<ul class="nav navbar-nav navbar-right">
					...
					<li class="dropdown">
						...
						<ul class="dropdown-menu color-gray" role="menu">
							...
							<li class="divider"></li>
							<?php  if(permission_check_account_user('see_system_upgrade')) { ?><li><a href="http://wpa.qq.com/msgrd?v=3&uin=850032&site=qq&menu=yes" target="_blank"><i class="wi wi-update color-gray"></i> 技术支持</a></li>
<?php  } ?>
