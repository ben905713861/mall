...
define('APP_URL', '//v2.addons.we7.cc/web/');
define('APP_STORE_URL', '//v2.addons.we7.cc/web');
define('APP_STORE_API', '//v2.addons.we7.cc/api.php');
if($_GET['res']) {
	$res = $_GET['res'];
	$reses = tpl_resources();
	...
	<body style="background-color:#28b0e4;">
		<div class="container">
			...
			<div class="footer" style="margin:15px auto;">
				...
				<div class="text-center">
					Powered by <a href="http://www.we7.cc"><b>微擎</b></a> x1.7.2 &copy; 2014 <a href="http://www.we7.cc">www.we7.cc</a>
				</div>
			</div>
		</div>
